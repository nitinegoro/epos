		...
		<div class="box-footer">
			<div class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" name="code" value="<?php echo set_value('code') ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="unit" value="<?php echo set_value('unit') ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						...
						<?php foreach($this->db->get('tb_category_product')->result() as $row) : ?>
							<option value="<?php echo $row->category_product ?>" <?php if(set_value('category') == $row->category_product) echo 'selected'; ?>><?php echo $row->category ?></option>
						<?php endforeach; ?>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="stock" value="<?php echo set_value('stock') ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="purchase" value="<?php echo set_value('purchase') ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="default_price" value="<?php echo set_value('default_price') ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="reseller_price" value="<?php echo set_value('reseller_price') ?>" class="form-control input-sm">
