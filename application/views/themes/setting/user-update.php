		...
		<div class="box-footer">
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-md-10">
					  	<input type="text" name="name" value="<?php echo (set_value('name')) ? set_value('name') : $user->name ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="email" name="email" value="<?php echo (set_value('email')) ? set_value('email') : $user->email ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="phone" value="<?php echo (set_value('phone')) ? set_value('phone') : $user->phone ?>" class="form-control input-sm">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						...
						<?php foreach($this->db->get('groups')->result() as $row) : ?>
							<option value="<?php echo $row->id ?>" <?php if($user->group_id == $row->id) echo 'selected'; ?>><?php echo $row->description ?></option>
						<?php endforeach; ?>
						</select>
